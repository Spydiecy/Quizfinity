...
import { icp_first_program_backend } from "../../../declarations/icp_first_program_backend";
...
export default function ResultTable(props) {
  ...
  const saveUserDataToBackend = async (userData) => {
    try {
      await icp_first_program_backend.saveUser(userData.userId, userData.earnPoints);
  ...
  const fetchUsers = async () => {
    try {
      const userList = await icp_first_program_backend.read();
